...
enum class IndexNumber: unsigned
{
    ...
    RESULT_RECORD_MYBEST_RATE_DECIMAL2,
		...
		INFO_RIVAL_BPM_MAX,
		INFO_RIVAL_BPM_MIN,
		INFO_RIVAL_LR2IR_RANK,
		INFO_RIVAL_LR2IR_TOTALPLAYER,
		INFO_RIVAL_LR2IR_CLEARRATE,
		INFO_RIVAL_LR2IR_SCORE_TO_RIVAL,
		...
		ARENA_PLAYDATA_SCORE = ARENA_PLAYDATA_BASE,
		ARENA_PLAYDATA_EXSCORE,
		ARENA_PLAYDATA_NOWCOMBO,
		ARENA_PLAYDATA_MAXCOMBO,
		ARENA_PLAYDATA_RATE,
		ARENA_PLAYDATA_RATEDECIMAL,
		ARENA_PLAYDATA_TOTALNOTES,
		ARENA_PLAYDATA_TOTAL_RATE,
		ARENA_PLAYDATA_TOTAL_RATEDECIMAL,
		ARENA_PLAYDATA_PERFECT,
		ARENA_PLAYDATA_GREAT,
		ARENA_PLAYDATA_GOOD,
		ARENA_PLAYDATA_BAD,
		ARENA_PLAYDATA_POOR,
		ARENA_PLAYDATA_BPOOR,
		ARENA_PLAYDATA_MISS,
		ARENA_PLAYDATA_BP,
		ARENA_PLAYDATA_COMBOBREAK,
		ARENA_PLAYDATA_GROOVEGAUGE,
		ARENA_PLAYDATA_NEXT_RANK_EX_DIFF,	// nextrank - ex
		ARENA_PLAYDATA_PLAYER_EX_DIFF,	// player - ex

		ARENA_PLAYDATA_MAX = ARENA_PLAYDATA_BASE + 30 - 1,
		...
		_SELECT_BAR_LEVEL_0,
		_SELECT_BAR_LEVEL_MAX = _SELECT_BAR_LEVEL_0 + 32,
