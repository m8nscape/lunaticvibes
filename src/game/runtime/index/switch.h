...
enum class IndexSwitch: unsigned
{
    ...
    CHART_HAVE_DIFFICULTY_1,
    CHART_HAVE_DIFFICULTY_2,
    CHART_HAVE_DIFFICULTY_3,
    CHART_HAVE_DIFFICULTY_4,
    CHART_HAVE_DIFFICULTY_5,

    CHART_HAVE_MULTIPLE_DIFFICULTY_1,
    CHART_HAVE_MULTIPLE_DIFFICULTY_2,
    CHART_HAVE_MULTIPLE_DIFFICULTY_3,
    CHART_HAVE_MULTIPLE_DIFFICULTY_4,
    CHART_HAVE_MULTIPLE_DIFFICULTY_5,
	...
	P1_SETTING_LANECOVER_TOP,
	P2_SETTING_LANECOVER_TOP,
        P1_SETTING_HISPEED,
        P2_SETTING_HISPEED,
        P1_HAS_LANECOVER_BOTTOM,
        P2_HAS_LANECOVER_BOTTOM,
